...
paviaTrain=newData(TrainIndex,:);
paviaTrain_gt=newData_gt(TrainIndex,1);
paviaValid=newData(ValidIndex,:);
paviaValid_gt=newData_gt(ValidIndex,1);
paviaTest=newData(TestIndex,:);
paviaTest_gt=newData_gt(TestIndex,1);
