...
paviaTrain=realData(TrainIndex,:);
paviaTrain_gt=realData_gt(TrainIndex,1);
paviaValid=realData(ValidIndex,:);
paviaValid_gt=realData_gt(ValidIndex,1);
paviaTest=realData(TestIndex,:);
paviaTest_gt=realData_gt(TestIndex,1);

%----------------------归一化
maxN=max(max(realData));
paviaTrain=paviaTrain/maxN;
paviaValid=paviaValid/maxN;
paviaTest=paviaTest/maxN;
