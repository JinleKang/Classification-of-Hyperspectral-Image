...
indianTrain=newData(TrainIndex,:);
indianTrain_gt=newData_gt(TrainIndex,1);
indianValid=newData(ValidIndex,:);
indianValid_gt=newData_gt(ValidIndex,1);
indianTest=newData(TestIndex,:);
indianTest_gt=newData_gt(TestIndex,1);

maxN=max(max(newData));
indianTrain=indianTrain/maxN;
indianValid=indianValid/maxN;
indianTest=indianTest/maxN;
